                        ...
                        @if ($edit_pass)
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="small text-muted mb-2"> Il est conseillé d'utliser un mot de passe sécurisé qui comporte : </p>
                            ...
                            <a class="btn btn-primary text-light" wire:click="update_password">Mettre à jour</a>
                            <button class="btn btn-secondary" wire:click="$toggle(edit_pass)">Fermer</button>
                        @endif
                    </form>
